...
from keras.layers import Layer, Input, Conv2D, Activation, add, BatchNormalization, UpSampling2D, ZeroPadding2D, Conv2DTranspose, Flatten, MaxPooling2D, AveragePooling2D, concatenate, InputSpec

# from keras.utils.conv_utils import normalize_data_format
# from keras.utils.backend.common import normalize_data_format
from instancenormalization import InstanceNormalization #, InputSpec
from keras.layers.advanced_activations import LeakyReLU
from keras.layers.core import Dense
from keras.optimizers import Adam
from keras.backend import mean, normalize_data_format
...
class DiamondGAN():
 ...
 #       self.gram_loss = gram_loss
        ...
        self.D_S_static = Network(inputs=image_S, outputs=guess_S, name='D_S_static_model')
        self.D_T_static = Network(inputs=image_T, outputs=guess_T, name='D_T_static_model')
